...
import { FilterValuesType, TaskType, TasksStateType } from "./types";
...
export function Todolist(props: PropsType) {
	...
	return (
		<div>
			...
			<div>
                Completed tasks: {props.tasks[props.id].filter(t => t.isDone).length}
			</div>
			<div>
                Uncompleted: { props.tasks[props.id].filter(t => !t.isDone).length }
			</div>
		</div>
	);
}
